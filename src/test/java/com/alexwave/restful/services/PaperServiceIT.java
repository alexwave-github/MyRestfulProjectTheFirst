...
@Slf4j
@SpringBootTest
class PaperServiceIT extends AbstractTestClass {
    ...
    void testFindAllThrowsException() {
        assertThat(catchThrowableOfType(PaperListIsEmptyException.class, () -> paperService.findAll())).isNotNull();
    }
    ...
    void testFindByIdThrowsException() {
        assertThat(catchThrowableOfType(PaperIdNotFoundException.class, () -> paperService.findById(1000))).isNotNull();
    }
    ...
    void testSaveThrowsException() {
        assertThat(catchThrowableOfType(AuthorIdNotFoundException.class, () -> paperService.save(new PaperDTO(), 1000))).isNotNull();
    }
    ...
    void testUpdateByIdThrowsException() {
        assertThat(catchThrowableOfType(PaperIdNotFoundException.class, () -> paperService.updateById(1000, new PaperDTO()))).isNotNull();
    }
    ...
    void testDeleteByIdThrowsException() {
        assertThat(catchThrowableOfType(PaperIdNotFoundException.class, () -> paperService.deleteById(1000))).isNotNull();
    }
}